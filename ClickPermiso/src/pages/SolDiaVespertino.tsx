...
const SolDiaVespertino = () => {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    e.preventDefault();
    console.log('Guardar solicitud vespertino:', formData);
    alert('Solicitud vespertina guardada correctamente');
  };
    ...
    <div className="flex-1 bg-gray-50 p-8">
      <div className="bg-white rounded-lg shadow p-8 max-w-5xl">
        <div className="flex justify-between items-center mb-6 pb-4 border-b">
          <h2 className="text-xl font-semibold">Solicitar Día Vespertino</h2>
...
export default SolDiaVespertino;