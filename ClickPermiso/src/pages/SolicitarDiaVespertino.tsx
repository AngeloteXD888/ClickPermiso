...
const SolicitarDiaVespertino = () => {
  ...
  const [formData, setFormData] = useState({
    ...
    telefono: '',
    jornada: '',
    turno: 'Vespertino', // Por defecto vespertino
    horasDocencia: '',
    diasPermiso: '',
    noRetribuido: false,
        ...
        <div className="flex justify-between items-center mb-8 pb-6 border-b-2 border-gray-200">
          <div className="flex items-center gap-2">
            ...
            <h2 className="text-xl font-semibold text-gray-900">
              Solicitar Día Vespertino: {obtenerFechaFormateada()}
            </h2>
          </div>
          <button 
            onClick={() => navigate(-1)}
...
export default SolicitarDiaVespertino;